...
musicApp.getRandomPlaylist = function (playlists) {
	...
	var chosenPlaylist = playlists[randomIndex].tracks.href;
...
musicApp.checkTracks = function (res) {
	...
	var spicyPercentage = Math.floor(musicApp.spiceCount / tracks.length * 100);
